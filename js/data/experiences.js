const experiencesData = {
  fr: [
    ...
    { type:"work", title:"Stagiaire — Transformation Digitale", company:"Box Africa", location:"Ouagadougou, Burkina Faso 🇧🇫", period:"Juillet — Septembre 2024", duration:"3 mois", current:false, description:"Contribution à des projets de digitalisation dans une entreprise IT africaine de référence.", highlights:["Développement web sous WordPress","Mise en place Windows Server","Présentations devant la Direction Générale","Production de contenus audiovisuels"] },
